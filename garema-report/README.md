...
| `photos/PH-01…15.jpg` | Site photographs, resized and orientation-corrected. |
...
| `SAQD_Works_Summary_Report_02_20-26_Aug_2026.pdf` | Generated — 5 pages, A4. |
...
1. Drop the new image in `photos/` named `PH-16.jpg` (continue the sequence, max ~1400 px, orientation corrected).
...
2–5. Photographic record — sections A to D, with the distribution list and signatures on the last sheet.
