...
| `photos/PH-01…26.jpg` | Site photographs and the two message directions, resized, cropped and orientation-corrected. |
...
| `SAQD_Works_Summary_Report_02_20-26_Aug_2026.pdf` | Generated — 4 pages, A4. |
...
1. Drop the new image in `photos/` named `PH-27.jpg` (continue the sequence, max ~1400 px, orientation corrected).
...
an extra page; nine photos per sheet in the 3-up grid is the working limit, and eight plus the closing panel
on the last sheet.

## Page structure

1. Executive summary — one page: project data, scope, progress by work front, coordination, safety, next period.
2–4. Photographic record — sections A to C, with the direction and distribution panel and the
     signatures on the last sheet.
